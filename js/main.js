...
/* harmony import */ var _templates_header_sticky__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./templates/_header-sticky */ "./src/js/templates/_header-sticky.js");
/* harmony import */ var _templates_pageNavigation__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./templates/_pageNavigation */ "./src/js/templates/_pageNavigation.js");

(0,_templates_burger__WEBPACK_IMPORTED_MODULE_0__.burger)();

var mixer = mixitup__WEBPACK_IMPORTED_MODULE_1___default()('.expertises__items', {
  load: {
    filter: '.engineering'
  }
});

var modal = new graph_modal__WEBPACK_IMPORTED_MODULE_2__["default"]('modal');

aos__WEBPACK_IMPORTED_MODULE_3___default().init({
  disable: 'phone'
});

(0,_templates_header_sticky__WEBPACK_IMPORTED_MODULE_4__.headerSticky)();

(0,_templates_pageNavigation__WEBPACK_IMPORTED_MODULE_5__.pageNavigation)();
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Thumbs]);
var aboutSlider = function aboutSlider() {
  if (document.querySelector('.about__main')) {
    ...
    var swiperMain = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](sliderMain, {
      loopedSlides: 4,
      thumbs: {
        swiper: swiperSmall
      },
...
var heroSlider = function heroSlider() {
  if (document.querySelector('.hero__swiper')) {
    return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', {
      loop: true,
      speed: 800,
      slidesPerGroup: 1,
      slidesPerView: 1,
...
var reviewsSlider = function reviewsSlider() {
  if (document.querySelector('.reviews__swiper')) {
    return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
      loop: true,
      speed: 800,
      slidesPerGroup: 1,
      slidesPerView: 1,
...
var headerSticky = function headerSticky() {
  ...
  var clickToOpenModal = false;
  var clickToCloseModal = false;
  var isAlreadyCloseModal = false;
  var counter = 0;
  var allCards = document.querySelectorAll('product-card');
  allCards.forEach(function (card) {
    var button = card.querySelector('[data-graph-path]');
    button.addEventListener('click', function () {
      return clickToOpenModal = true;
    });
  });
  var modal = document.querySelector('.graph-modal');
  modal.addEventListener('click', function () {
    return clickToCloseModal = true;
  });
